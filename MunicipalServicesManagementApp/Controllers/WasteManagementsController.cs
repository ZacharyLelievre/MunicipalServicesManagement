...
namespace MunicipalServicesManagementApp.Controllers
{
    public class WasteManagementsController : Controller
    {
        ...
        public WasteManagementsController(MunicipalDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Area,WasteGenerated,CollectionDate")] WasteManagement wasteManagement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Area,WasteGenerated,CollectionDate")] WasteManagement wasteManagement)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!WasteManagementExists(wasteManagement.Id))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.WasteManagements.Any(e => e.Id == id);
        }
    }
}
